...
$menu_selecionado = array('Categorias', 'Adicionar Categoria');
$custom_folder = "cliente";
$custom_header_files = "categoria";
$custom_footer_files = "add-categoria";
...
<div class="az-content-body" >
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="card  ht-md-100p">
                ...
                <div class="alert icon-alert with-arrow alert-success form-alter" role="alert" style="display:none;">
                    ...
                    <strong> Categoria </strong> adicionada com sucesso.
                </div>
 ...
 <form id="nova-categoria-form" name="nova-categoria-form" method="post" enctype="multipart/form-data" >
 <input type="hidden" id="form_name" name="form_name" value="add-categoria"/>
        ...
        <div class="col-md-4 order-md-1 order-sm-2 order-xs-2">
              <h4 class="mb-3 titulos">Dados da Categoria</h4>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="" value="" autocomplete="off"  required>
                    <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
           
                    <div class="mb-3">
                <label for="ordem">Ordem *</label>
                    <input type="text" class="form-control" id="ordem" name="ordem" placeholder="" value="" autocomplete="off"  required>
                ...
                <label for="preview">Imagem: </label><br/>
                    ...
                    <img src="img/placeholder4.png" id="preview" alt="" width="260" style="border:1px solid #acacac" class="img-fluid upimage order-1 order-lg-2 mb-1"><br/>
